@props(['title' => __('Setujui password'), 'content' => __('Demi keamanan Anda, harap konfirmasikan kata sandi Anda untuk melanjutkan.'), 'button' => __('Konfirmasi')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Kata Sandi') }}" x-ref="confirmable_password" wire:model.defer="confirmablePassword" wire:keydown.enter="confirmPassword" />
