    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                Data Kota Asal Keberangkatan Kereta
                            ...
                            @foreach ($awal as $data)
                                <tr scope="row">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('asal.edit',$data->id)}}" class="btn btn-success">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a href="{{route('asal.show',$data->id)}}" class="btn btn-warning">
